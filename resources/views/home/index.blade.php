                            ...
                            <div id="main_slider" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <div class="client_img"><img src="images/img-raka.jpg"
                                                style="width: 200px; border-radius: 5px"></div>
                                    </div>
                                    <div class="carousel-item">
                                        ...
                                        <div class="client_img"><img src="images/img-safrina.jpg"
                                                style="width: 200px; border-radius: 5px"></div>
                                    </div>
                                    <div class="carousel-item">
                                        <p class="testimonial_text">tempor incididunt ut labore et dolore magna aliqua. Ut
                                        ...
                                        <div class="client_img"><img src="images/img-hilman.jpg" style="width: 200px; border-radius: 5px"></div>
                                    </div>
                                </div>
